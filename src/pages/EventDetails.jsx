                    ...
                    <Controller
                      ...
                      rules={{
                        ...
                        validate: (value) => {
                          ...
                          // Extract the part after '+91' and ensure it's exactly 10 digits
                          const phoneNumber = value.replace("+91", "").trim();
                          if (
                            phoneNumber.length !== 10 ||
                            !/^\d{10}$/.test(phoneNumber)
                          ) {
                            return "Phone number must contain exactly 10 digits after +91";
                          }
                          return true;
                        },
                      }}
                      render={({ field }) => (
                        <Input
                          ...
                          onChange={(e) => {
                            // Prevent the user from modifying the '+91' part
