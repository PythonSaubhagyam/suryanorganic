  ...
  return (
    <>
      ...
      <Container maxW={"container.xl"} mb={4} px={0} centerContent>
        <Image src={"/Suryan Organic/Privacy-policy/Privacy_Policy.jpg"} />
        <VStack maxW={"6xl"} my={8} px={6}>
          <Box color={"text.300"} textAlign={"justify"}>
            ...
            (https://www.suryanorganic.com/) further referenced as
            ...
            suryanorganic.com. It does not govern any other information or
            ...
            <br />
            In general, you can visit the www.suryanorganic.com without telling
